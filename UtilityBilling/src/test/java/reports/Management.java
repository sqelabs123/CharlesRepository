...
public class Management extends Sauce_Instance_Login_Test{
	...
	public static String header="html/body/div[5]/div/div[2]/div[2]/div[2]/div[1]/h2";
				...
				*/
				...
				//search the record
				driver.findElement(By.xpath(".//*[@id='DataTables_Table_0_filter']/label/input")).sendKeys(customer);
				Thread.sleep(2000);
				...
				//username
				driver.findElement(By.xpath("html/body/div[5]/div/div[2]/div[2]/div[2]/div[3]/form/div[1]/div/input")).sendKeys("test123@sqelabs.com");
				//nxt
				 WebElement element = driver.findElement(By.tagName("a"));
				 JavascriptExecutor executor = (JavascriptExecutor)driver;
				 executor.executeScript("javascript:getReport();", element);
				...
				//search the record
				driver.findElement(By.xpath("html/body/div[5]/div/div[2]/div[2]/div[3]/div/div/div[3]/div/div[2]/label/input")).sendKeys("test123@sqelabs.com");
				Thread.sleep(2000);
