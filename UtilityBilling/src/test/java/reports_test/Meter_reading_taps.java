...
public class Meter_reading_taps extends Sauce_Instance_Login_Test{
	...
	public static String cus_name="Vicky Singhania";
			...
			Thread.sleep(2000);
				...
				@Test(priority = 2)
				public void Meter_Reading_Sheet_with_Peak_Shoulder() throws InterruptedException, IOException
				{
				//********************************************************************************************
					...
					Thread.sleep(500);
				//Click on Meter Reading Sheet link
				driver.findElement(By.linkText("Meter Reading Sheet with Peak, Off Peak, Shoulder")).click();
				Thread.sleep(2000);
